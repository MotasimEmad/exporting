  ...
  return (
    ...
    <div class="container px-6 py-12 mx-auto">
        <div class="text-center ">
            ...
            <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl ">We’d <div class="relative inline-block mx-2">
                                <span class="absolute -rotate-6 bg-secondary/50 px-2 py-1 inset-0 mt-4"></span>
                                <span class="relative text-secondary font-bold">love</span>
                            </div> to hear from you</h1>
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
            <div class="p-4 rounded-lg bg-primary/10 md:p-6 ">
                <span class="inline-block p-3 text-primary rounded-lg text-primary/80 ">
            ...
            <div class="p-4 rounded-lg bg-primary/10 md:p-6 ">
                ...
                <p class="mt-2 text-sm text-primary ">100 Smith Street Collingwood VIC 3066 AU</p>
            </div>
            ...
            <div class="p-4 rounded-lg bg-primary/10 md:p-6 ">
                ...
                <p class="mt-2 text-sm text-primary ">+1 (555) 000-0000</p>
            </div>
        </div>
    </div>
</section>
